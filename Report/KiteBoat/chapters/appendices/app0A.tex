...
public class Buoy : MonoBehaviour
{
	...
	// returns true if the point is inside the mesh collider
	private static bool PointIsInsideMeshCollider(Collider meshColl, Vector3 point)
	{
		...
		{
			RaycastHit hit;
			if (meshColl.Raycast(new Ray(point - ray * 1000, ray), out hit, 1000f) == false)
			{
				return false;
			}
		}
	...
	// returns the two closest points in the list
	...
	private static void JoinPoints(IList<Vector3> list, int targetCount)
	{
	...
	private float GetWaterLevel(float xCoord, float zCoord)
	{
        if (water == null)
        {
